...
const QnAPage = () => {
    ...
    <div data-component="OPageContent" className="o-page-content" data-component-id="84f821cb-b419-4c7f-b066-9f1c61032e83" style={{"marginTop": "56px"}}>
        ...
        <div className="o-my-page o-width wc-75" style={{"marginTop": "51px"}}>
            ...
            <div className="arket-qna-register mp-30">
            <h2>1:1 문의</h2>
            <ul>
                ...
                <li className="table">
                   <ul>
                        ...
                        <li class="selectbox-area">
                            <div className='d1'>
                            <button className='d2 select general' onClick={()=>onSelectBoxClicked(1)}>
                                {selectBoxText1}
                                <span className='arrow-down'></span>
                                <div className='result d2' style={{"display":selectBox1?"flex":"none"}}>
                                    <ul>
                                            {
                                                ["찾아보기","없음1","없음2","없음3","없음4"].map((text)=>(
                                                    <li onClick={()=>{onSelectBoxElementClicked(1,text)}}>{text}</li>
                                                ))
                                            }
                                    </ul>
                                </div>
                   ...
                   <ul className='mp-30'>
                        ...
                        <li>
                            ...
                            <input type="checkbox" id="check1"/> <label for="check1"></label>선택할 상품 없음
                        </li>
                   </ul>
                   <ul>
                        <li>제목*</li>
                        <li><input type="text" className='d1 m1'/></li>
                   </ul>
                   <ul>
                        <li>문의 내용*<br/>({textContent.length}/500자)</li>
                        <li><textarea className='d1 m1' value={textContent} onChange={(event)=>{
                   ...
                   <ul>
                        ...
                        <li className="selectbox-area">
                            <div className='d1'>
                                <input type="text" className='d2 m15'/>
                                <button className='ml-12 d5 select m4' onClick={()=>{onSelectBoxClicked(2)}}>{selectBoxText2} <span className='arrow-down'></span>
                                    <div className='result d1' style={{"display" : selectBox2 ? "flex" : "none"}}>
                                        <ul>
                                            {
                                                ["선택하기","naver.com","daum.net","gmail.com","직접입력"].map((url)=>(
                                                    <li onClick={()=>{onSelectBoxElementClicked(2,url)}}>{url}</li>
                                                ))
                                            }
                                        </ul>
                                    </div>
                   ...
                   <ul className='mp-30'>
                        <li>SMS 답변 알림</li>
                        <li><input type="text" className='d2 m1'/></li>
                   </ul>
                   <ul>
                        <li></li>
                        <li>
