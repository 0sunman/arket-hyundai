...
import qna from "./qna.module.scss";

const Header = () => (
  <li className="header table-row">
    <ul>
      <li>문의일</li>
      <li>문의유형</li>
      <li>제목</li>
        ...
        <div className="o-my-page o-width wc-75" style={{ marginTop: "51px" }}>
            ...
            >
              ...
              <div className="o-list js-o-list" style={{ overflow: "hidden" }}>
                <ul>
                  ...
                  <li
                    data-selected="MEMBER_DELIVERY_LIST"
                    id="delivert-main-tab"
                  >
                    <a
          ...
          <div className={qna.arketQna}>
            ...
            <div className="selectbox-area">
              <div>
                <button>
                  전체보기<span className="arrow-down"></span>
                </button>
              </div>
              <div>
                <button>
                  1개월 보기<span className="arrow-down"></span>
                </button>
              </div>
            </div>
            <ul>
                  ...
                  ({
                    ...
                    <ul className="content">
                      ...
                      >
                        ...
                        <li
                          className="answer"
                          style={{ display: answeryn ? "flex" : "none" }}
                        >
