    ...
    <>
      ...
      >
        <div className="content-section favorite stories">
          <div
            className="u-cols-lg-12-24 u-cols-md-8-12 u-cols-sm-8-8 u-align-to-logo"
            id="sizeguide2022"
          >
            <div className="m-teaser blog-teaser">
              <h1 className="a-heading-1 q-mega">
                Customer Service / 사이즈 가이드
              </h1>
            </div>
            <div className="accordion-group">
              <div
                ...
                data-exclusive-group="customer-service"
                data-component-id="a926edb4-67ea-4629-b45e-8a9f748fe13c"
              >
                ...
                <div className="accordion-content">
                  <div className="accordion-inner-content">
                    <div className="sizeguide">
                      <img
                        className="sizeguide_doll"
                        src="https://image.thehyundai.com/stories_cdn/images/hdstories/guide/sizeguide_doll.png"
                        alt="size guide"
                      />
                      <h4 className="a-heading-4 txt_left">A : 가슴둘레</h4>
                      <p className="a-paragraph">
                        몸에 잘 맞는 브라를 착용한 상태로, 가장 볼륨이 있는
                        둘레를 측정합니다.
                      </p>
              ...
              <div
                ...
                data-exclusive="data-exclusive"
                data-exclusive-group="customer-service"
                data-component-id="6c856240-a8e1-4d61-b362-97df195d7b60"
              >
                <div className="accordion-header">
                  <a
                    href="#"
              ...
              <div
                ...
                data-exclusive="data-exclusive"
                data-exclusive-group="customer-service"
                data-component-id="15747765-36bc-4690-bf24-b6f8b03f3ed7"
              >
                <div className="accordion-header">
                  <a
                    href="#"
                    ...
                    <div className="sizeguide">
                      <table>
                        ...
                        <tbody>
                          <tr>
                            <th scope="row"></th>
                            <th scope="col">유럽/한국 (EU/KR)</th>
                            <th scope="col">슴둘레</th>
                            <th scope="col">허리둘레</th>
                            <th scope="col">엉덩이둘레</th>
                            <th scope="col">다리길이</th>
                          </tr>
                          <tr>
                            <th scope="row">XXS</th>
                            <td>30</td>
              ...
              <div
                ...
                data-exclusive="data-exclusive"
                data-exclusive-group="customer-service"
                data-component-id="e03868a1-780c-4e8e-8c57-88bad9bbed41"
              >
                <div className="accordion-header">
                  <a
                    href="#"
                  ...
                  <div className="accordion-inner-content">
                    <div className="sizeguide size-75">
                      ...
                      <table>
                        ...
                        <tbody>
                          <tr>
                            <th scope="col">인심 길이 (INCH)</th>
                            <th scope="col">인심 길이 (CM)</th>
                          </tr>
                          <tr>
                            <th>28''</th>
                            <td>71</td>
              ...
              <div
                data-component="OAccordion"
                className="o-accordion is-visible"
                data-exclusive="data-exclusive"
                data-exclusive-group="customer-service"
                data-component-id="2cdb49f4-7da4-4717-bf25-ba0faf860098"
              >
                <div className="accordion-header">
                  <a
                    href="#"
                ...
                <div className="accordion-content">
                  <div className="accordion-inner-content">
                    <div className="sizeguide size-75">
                      <table>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <th scope="col">발볼 둘레</th>
                            <th scope="col">종아리 둘레</th>
                          </tr>
                          <tr>
                            <th scope="row">35</th>
                            <td>225mm</td>
                      ...
                      <p class="a-paragraph">
                        <img
                          src="https://www.stories.com/content/dam/Stories/Images/CustomerService/SizeGuide/Size_guide_foot.jpg"
                          alt="Size guide shoes"
                        />
                      </p>
                      <p
                        class="a-paragraph"
                      ...
                      >
                        A: 발 길이: 발의 뒤꿈치 끝부터 가장 긴 발가락 끝 사이의
                        길이를 잽니다.
                        <br />
                        B: 발볼 둘레: 발에서 가장 넓은 부분의 둘레를 잽니다.
                        <br />
                        C: 종아리 둘레: 종아리에서 가장 두꺼운 부분의 둘레를
                        잽니다.
                      </p>
                    </div>
                  </div>
              ...
              <div
                ...
                data-exclusive="data-exclusive"
                data-exclusive-group="customer-service"
                data-component-id="ce0a1fd7-c20a-4344-95f3-85ea0874075b"
              >
                <div className="accordion-header">
                  <a
                    href="#"
                ...
                <div className="accordion-content">
                  <div className="accordion-inner-content">
                    <div className="sizeguide bra">
                      ...
                      <h4 className="a-heading-4 txt_left">밴드 사이즈</h4>
                      <p className="a-paragraph">
                        브라 사이즈 표시의 숫자는 밑가슴둘레를 나타냅니다.
                        줄자를 타이트하게 가슴 바로 아래 부분을 측정한 다음,
                        반올림하세요. 예를 들어, 72cm를 측정하면 브라 사이즈는
                        70입니다.
                      </p>
                      <h4 className="a-heading-4 txt_left">컵 사이즈</h4>
                      <p className="a-paragraph">
                        사이즈의 알파벳은 컵 사이즈를 나타냅니다. 만약 75B
                        사이즈를 착용했을 때 너무 작다고 느낀다면, 75C를
                        입어보세요. 밴드 사이즈는 같지만 컵 사이즈가 더 큽니다.
                      </p>
                      <table>
              ...
              <div
                ...
                data-exclusive="data-exclusive"
                data-exclusive-group="customer-service"
                data-component-id="3bf40127-0e7c-4e7a-bf57-7e9ad80df9fc"
              >
                <div className="accordion-header">
                  <a
                    href="#"
                      ...
                      <table>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <th scope="col">영국</th>
                            <th scope="col">유럽</th>
                            <th scope="col">프랑스/스페인</th>
                            <th scope="col">허리둘레(CM)</th>
                          </tr>
                          <tr>
                            <th scope="row">XS</th>
                            <td>8</td>
              ...
              <div
                ...
                data-exclusive="data-exclusive"
                data-exclusive-group="customer-service"
                data-component-id="fd652b78-fd11-45c2-98f2-83114ef265c1"
              >
                <div className="accordion-header">
                  <a
                    href="#"
                ...
                <div className="accordion-content">
                  <div className="accordion-inner-content">
                    <p className="a-paragraph">
                      종이 위에 손을 평평하게 놓고 펜을 세워 손을 따라
                      그려보세요. 그런 다음 손가락 마디가 시작되는 부분 아래의
                      너비를 측정합니다. 가장 가까운 사이즈로 반올림하세요.
                    </p>
              ...
              <div
                ...
                data-exclusive="data-exclusive"
                data-exclusive-group="customer-service"
                data-component-id="c1fa75f4-06bf-4a5f-a60a-5a567f9435f6"
              >
                <div className="accordion-header">
                  <a
                    href="#"
